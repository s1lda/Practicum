...
model_save_path = 'C:/Users/ZALMAN/Downloads/'

data_regression = pd.read_csv('C:/Users/ZALMAN/Downloads/housing23.csv')

data_classification = pd.read_csv("C:/Users/ZALMAN/Downloads/smoke2.csv")
...
def load_models():
    model_classification = pickle.load(open(model_save_path + 'Ridge.pkl', 'rb'))
    model_regression = pickle.load(open(model_save_path + 'TweedieRegressor.pkl', 'rb'))
